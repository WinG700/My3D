...
void BuildWorld(UWorld* world)
{
	...
	//添加一个三棱锥
	Actor* TriangularPrism = new Actor(FTransfrom(Vector3(0, 0, 0), Quaternions(0, 0, 0, 1), Vector3(0.5)));
	TriangularPrism->AddVertex({Vector3(250.0/cos(Radian(30.0)), 0, 0), Vector3(-250.0*tan(Radian(30.0)), 250.0, 0),  Vector3(-250.0 * tan(Radian(30.0)), -250.0, 0) , Vector3(0, 0, 500)});
